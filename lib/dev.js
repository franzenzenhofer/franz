...
(function() {
  var Franz, byArray, byImage, cbr, clamp, copy, crop, dlog, fff, getGrayscaleValue, getToolbox, hardResize, ifw, isFunction, mF, make, nb, newToolbox, resize, rgba, scale, toArray, toImage, _DEBUG_,
    __slice = [].slice;
  ...
  Franz.viewfinder = function(c, cb) {
    var pic;
