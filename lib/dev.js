...
(function() {
  var FALSE, Franz, TRUE, byArray, byImage, cbr, clamp, copy, crop, dlog, fff, fffr, getGrayscaleValue, getToolbox, hardResize, ifw, isFunction, mF, make, nb, newToolbox, resize, rgba, scale, toArray, toImage, _DEBUG_,
    __slice = [].slice;
